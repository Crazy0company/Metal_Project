...
$('.waifu-tool .fui-eye').click(function (){//换人
    loadOtherModel();
});

$('.waifu-tool .fui-chat').click(function (){//一言
    showHitokoto();
});
...
(function (){
    ...
    var SiteIndexUrl = 'https://localhost:8080/metal_project/game/index.jsp'; 
